...
class _PickMapScreenState extends State<PickMapScreen> {
  ...
  late CameraPosition
      _cameraPosition; //=CameraPosition(target: LatLng(double.parse(Get.find<LocationController>().getAddress["latitude"]), double.parse(Get.find<LocationController>().getAddress["longitude"]))  /*LatLng(45.521563, -122.677433)*/,zoom: 17);
            ...
            GoogleMap(
              initialCameraPosition: CameraPosition(
                target: widget.fromAddAddress
                    ? _initialPosition /*LatLng(locationController.position.latitude, locationController.position.longitude)*/
                    : _initialPosition,
                zoom: 17,
              ),
