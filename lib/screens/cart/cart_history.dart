 ...
 */
    ...
    Widget timeWidget(int index) {
      ...
      if (index < cartHistory.length) {
        DateTime parseDate =
            DateFormat("yyyy-MM-dd HH:mm:ss").parse(cartHistory[index].time!);
    ...
    return Scaffold(
      ...
      GetBuilder<CartController>(builder: (_cartController) {
        print("History length is " +
            _cartController.getCartHistory().length.toString());
                                    ...
                                    child: Column(
                                      ...
                                      return BigText(text:outputDate, color:AppColors.titleColor);*/
                                        ...
                                        Wrap(
                                            ...
                                            children: List.generate(xy[index],
                                                (index1) {
                                              if (listCounter <
                                                  cartHistory.length) {
                                                listCounter++;
